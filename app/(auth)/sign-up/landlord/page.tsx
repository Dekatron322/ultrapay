...
const LandLordSignUp: React.FC = () => {
  ...
  const validateStep2 = () => {
    const { propertyType, numberOfProperties, propertyLocation } = formData
    if (!propertyType || !numberOfProperties || !propertyLocation.trim()) {
      setFormError("Please fill in all property information fields")
      return false
    }

    if (isNaN(Number(numberOfProperties)) || Number(numberOfProperties) < 1) {
      setFormError("Please enter a valid number of properties")
      return false
    }
        ...
        >
          ...
          >
            <div className="mx-4 mb-8 border-b pb-6 text-center">
              <h1 className="text-3xl font-bold text-[#1447E6]">Landlord&apos;s Corner</h1>
              <p className="mt-2 text-[#101836]">Create an account to manage your properties.</p>
            </div>
              ...
              {currentStep === 2 && (
                ...
                >
                  ...
                  <FormInputModule
                    ...
                    placeholder="Enter primary property location"
