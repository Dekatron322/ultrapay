...
const AgentSignUp: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    numberOfAgents: "",
    operatingRegions: "",
    assignedEstate: "", // Estate this agency will manage
  ...
  // Years in operation options (reuse)
  ...
  const specializationOptions = [
    ...
    { value: "mixed-use", label: "Mixed-Use Properties" },
    { value: "property-management", label: "Property Management" },
    { value: "tenant-relations", label: "Tenant Relations" },
    { value: "maintenance-coordination", label: "Maintenance Coordination" },
  ]
  ...
  const validateStep1 = () => {
    const { agencyName, registrationNumber, email, phone, hqAddress } = formData
    if (!agencyName.trim() || !registrationNumber.trim() || !email.trim() || !phone.trim() || !hqAddress.trim()) {
  ...
  const validateStep2 = () => {
    const { yearsOperation, specialization, numberOfAgents, assignedEstate } = formData
    if (!yearsOperation || !specialization || !assignedEstate || String(numberOfAgents).trim() === "") {
      setFormError("Please fill in all operations information fields")
      return false
    }
        ...
        >
          ...
          >
            <div className="mx-4 mb-8 border-b pb-6 text-center">
              <h1 className="text-3xl font-bold text-[#1447E6]">Agency Registration</h1>
              <p className="mt-2 text-[#101836]">Register your agency to manage estates efficiently on our platform.</p>
            </div>
              ...
              {currentStep === 1 && (
                ...
                >
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <FormInputModule
                      label="CAC/RC Registration Number"
                      type="text"
              ...
              {currentStep === 2 && (
                ...
                >
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    />
                    <FormInputModule
                      label="Operating Regions/Cities (optional)"
                      type="text"
                  ...
                  <FormInputModule
                    label="Assigned Estate Code"
                    type="text"
                    name="assignedEstate"
                    placeholder="Enter estate code provided to you"
                    ...
                    <div className="-mt-2 space-y-2">
                      ...
                      {estateInfo && (
                        <div className="rounded-md border border-[#1447E6] bg-[#F3F4F6] p-3">
                          <p className="text-sm font-medium text-[#100A55]">Estate Information</p>
                          <ul className="mt-1 space-y-1 text-sm text-[#5B5B7B]">
                            <li>
                              <span className="font-medium text-[#100A55]">Name:</span> {estateInfo.name}
                            </li>
                            <li>
                              <span className="font-medium text-[#100A55]">Location:</span> {estateInfo.location}
                            </li>
                            <li>
                              <span className="font-medium text-[#100A55]">Buildings:</span> {estateInfo.buildingsCount}
                            </li>
                            <li className="text-xs text-[#8B8BA6]">Code: {estateInfo.id}</li>
                          </ul>
                        </div>
                      )}
                    </div>
