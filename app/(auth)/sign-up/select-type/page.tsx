...
const SignUpTypeSelection: React.FC = () => {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-gradient-to-br from-[#ffffff]">
      {/* Logo with full-width border */}

      {/* Main Content */}
      <div className="relative flex w-full max-w-4xl flex-col px-4">
        <motion.main
        ...
        >
          ...
          >
            <Image src="/ultra-pay/logo.png" alt="Logo" width={155} height={100} className="mx-auto mb-8" />
